...
export class Settings extends HTMLElement {
				...
				<div id="settings">
					...
					<div id="settings-type" class="settings-section">
						<div class="type-selection">
							...
							<label for="logo-select" title="generate a planet logo">
							...
							<label for="pattern-select" title="generate star backgroundpattern">
					...
					<div id="settings-logo" class="settings-section">
						<div id="color-mode-selector">
							<button id="setColor" class="activeColorMode" title="set logo to colored mode">
							...
							<button id="setMonochrome" title="set logo to monochrome">
						...
						<div class="angle-slider">
							<label for="angleSlider" title="rotate logo rings clockwise">
							...
							<span title="rotate logo rings anticlockwise">
								<svg transform="scale(1,-1)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M819-28 701-146q-48 32-103.5 49T480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-62 17-117.5T146-701L27-820l57-57L876-85l-57 57ZM440-162v-78q-33 0-56.5-23.5T360-320v-40L168-552q-3 18-5.5 36t-2.5 36q0 121 79.5 212T440-162Zm374-99-58-58q21-37 32.5-77.5T800-480q0-98-54.5-179T600-776v16q0 33-23.5 56.5T520-680h-80v45L261-814q48-31 103-48.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 61-17.5 116T814-261Z"/></svg>
							</span>
						</div>
						<div class="text-inputs">
							<input type="text" id="top-text" placeholder="Enter top text" value="WHY">
							<button id="text-swap" title="swap top and bottom text">
							...
							<label for="flip-text" title="flip bottom text">
					...
					<div class="angle-slider" id="settings-logosize" class="settings-section">
						...
						<label for="logoSizeSlider" title="scale logo up">
					...
					<div class="angle-slider" id="settings-logorotation" class="settings-section">
						<label title="rotate logo anticlockwise">
						...
						<label for="logoRotationSlider" title="rotate logo clockwise">
					...
					<div id="settings-pattern" class="settings-section">
						...
						<label for="preview-toggle" title="preview image as tile">
					...
					<div id="download-buttons" class="settings-section">
						<button id="downloadSvg" alt="Download Vectorgraphic as SVG" title="Download Vectorgraphic as SVG">
						...
						<button id="downloadPng" alt="Download Image as PNG" title="Download Image as PNG">
							<svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#e8eaed"><path d="M480-313 287-506l43-43 120 120v-371h60v371l120-120 43 43-193 193ZM220-160q-24 0-42-18t-18-42v-143h60v143h520v-143h60v143q0 24-18 42t-42 18H220Z"/></svg>
	...
	connectedCallback() {
		...
		this.shadow.getElementById('flip-text').addEventListener('click', () => {
			this.paperCanvas.setText(this.shadow.getElementById('top-text').value, this.shadow.getElementById('bottom-text').value, this.shadow.getElementById('flip-text').checked)
			this.paperCanvas.setType(this.getType())
			if(this.getType() !== 'logo'){
				this.paperCanvas.setLogoSize(this.shadow.getElementById('logoSizeSlider').value)
				this.paperCanvas.setLogoRotation(this.shadow.getElementById('logoRotationSlider').value)
			}
		})
